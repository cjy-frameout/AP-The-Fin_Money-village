...
function inc_IAHead(){
	...
	str+='<colgroup>';
	str+='	<col width="2%" /><!-- 번호 -->';
	str+='	<col class="depth2" style="width:7%" /><!-- 2Depth -->';
	str+='	<col class="depth3" style="width:7%" /><!-- 3Depth -->';
	str+='	<col class="depth4" style="width:7%" /><!-- 4Depth -->';
	str+='	<col class="depth5" style="width:7%" /><!-- 4Depth -->';
	str+='	<col class="depth6" style="width:7%" /><!-- 5Depth -->';
	...
	str+='	<col class="rdate" style="width:4%" /><!-- 패키지 구분 -->';
	str+='	<col class="id" style="width:6%" /><!-- ID -->';
	str+='	<col class="info" style="width:11%" /><!-- 요약 -->';
	...
	str+='		<th scope="col" class="depth5">Level5</th>';
	...
	str+='		<th scope="col" class="pckg">Package</th>';
