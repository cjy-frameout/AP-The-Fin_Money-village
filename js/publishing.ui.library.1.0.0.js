    ...
    if ($(".tabs_wrap.type_scroll").length) {
        ...
        $(window).scroll(function () {
            ...
            if ($windowTop < $activePosArea + $orgEq0) {
                ...
                $windowTop <
                $activePosArea + $orgEq0 + $orgEq1 + $orgEq2
            ) {
                $(".tabs_wrap .btn_sel_org:nth-child(3)")
                    .addClass("on")
                    .siblings()
                    .removeClass("on");
                ...
                $windowTop <
                $activePosArea + $orgEq0 + $orgEq1 + $orgEq2 + $orgEq3
            ) {
                $(".tabs_wrap .btn_sel_org:nth-child(4)")
                    .addClass("on")
                    .siblings()
                    .removeClass("on");
                ...
                $windowTop <
                $activePosArea + $orgEq0 + $orgEq1 + $orgEq2 + $orgEq3 + $orgEq4
            ) {
                $(".tabs_wrap .btn_sel_org:nth-child(5)")
                    .addClass("on")
                    .siblings()
                    .removeClass("on");
                ...
                $(".tabs_wrap .btn_sel_org:nth-child(6)")
                    .addClass("on")
                    .siblings()
                    .removeClass("on");
                ...
                $(".tabs_wrap .btn_sel_org:nth-child(7)")
                    .addClass("on")
                    .siblings()
                    .removeClass("on");
                $(".tabs_header.type2 ul").scrollLeft(220);
                ...
                $(".tabs_wrap .btn_sel_org:nth-child(8)")
                    .addClass("on")
                    .siblings()
                    .removeClass("on");
                $(".tabs_header.type2 ul").scrollLeft(220);
        ...
        if (
            $(
                ".tabs_wrap.type_scroll .ins1Link_wrap .org_wrap:last-child"
            ).outerHeight(true) <
            $(window).height() -
                $(".fix_bottom").outerHeight(true) -
                $(".tabs_header").outerHeight(true)
        ) {
            $(".tabs_wrap.type_scroll .ins1Link_wrap .org_wrap:last-child").css(
                "padding-bottom",
                $(window).height() -
                    $(
                        ".tabs_wrap.type_scroll .ins1Link_wrap .org_wrap:last-child"
